...
have lean_s0 : (Or (And (Eq x b) (Eq y b)) (Or (Not (Eq x b)) (Not (Eq y b)))) := sorry
...
have lean_s8 : (Iff (Or (And (Eq x a) (Eq y a)) (And (Eq x b) (Eq y b))) (And (Or (And (Eq x a) (Eq y a)) (And (Eq x b) (Eq y b))) ((Or (And (Eq x a) (Eq y a)) (And (Eq x b) (Eq y b))) -> (Eq x y)))) := by simp
...
have lean_s23 : (Iff (Iff (Not (Not (Eq y a))) (Eq y a)) (Iff (Eq y a) (Not (Not (Eq y a))))) := by simp
let lean_s24 := rfl
have lean_s25 : (Iff (Eq y a) (Eq y a)) := Iff.rfl
let lean_s26 := by smtCong lean_s24, lean_s25
have lean_s27 : (Iff (Not (Not (Eq y a))) (Eq y a)) := by simp
