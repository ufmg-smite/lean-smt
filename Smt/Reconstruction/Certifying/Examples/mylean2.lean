...
have lean_s1 : (Or (Not (Eq x b)) (Or (Not (Eq y b)) (Eq (f x) (f y)))) :=
  (scope (fun lean_a2 : (Eq x b) =>
    (scope (fun lean_a3 : (Eq y b) =>
      have lean_s1 : (And (Eq y b) (Eq x b)) := sorry
...
have lean_s10 : (Or (And (Eq x a) (Eq y a)) (And (Eq x b) (Eq y b))) := sorry
  ...
  (scope (fun lean_a4 : (Eq x a) =>
    (scope (fun lean_a5 : (Eq x b) =>
      (scope (fun lean_a6 : (Not (Eq y a)) =>
        let lean_s14 := sorry
        have lean_s15 : (And (Not (Eq y a)) (And (Eq x a) (Eq x b))) := sorry
          ...
          (scope (fun lean_a6 : (Not (Eq y a)) =>
            (scope (fun lean_a7 : (Eq x a) =>
              (scope (fun lean_a8 : (Eq x b) =>
                ...
                have lean_s23 : (Iff (Eq y b) (Eq y a)) := sorry
                have lean_s24 : (Iff (Eq y a) False) := sorry
                have lean_s25 : (Iff (Eq y b) False) := sorry
                have lean_s26 : (Not (Eq y b)) := sorry
                show (Not (Eq y b)) from lean_s26
          ))))))
        have lean_s17 : ((And (Not (Eq y a)) (And (Eq x a) (Eq x b))) -> (Not (Eq y b))) := by liftOrNToImp lean_s16, 3
        have lean_s18 : (Not (Eq y b)) := sorry
...
have lean_s24 : (Eq @Eq @Eq) := rfl
have lean_s25 : (Iff (Eq y a) (Eq y a)) := Iff.rfl
have lean_s27 : (Iff (Not (Not (Eq y a))) (Eq y a)) := sorry
have lean_s28 : (Iff (Iff (Eq y a) (Not (Not (Eq y a)))) (Iff (Eq y a) (Eq y a))) := sorry
...
have lean_s32 : (Iff (Not (Not (Eq y a))) (Eq y a)) := sorry
have lean_s34 : (Iff (Not (Eq y b)) (Not (Eq y b))) := Iff.rfl
have lean_s37 : (Iff (Or (Not (Eq x a)) (Or (Not (Eq x b)) (Or (Not (Not (Eq y a))) (Not (Eq y b))))) (Or (Not (Eq x a)) (Or (Not (Eq x b)) (Or (Eq y a) (Not (Eq y b)))))) := sorry
...
have lean_s43 : (Or (Eq y a) (Or (Not (Eq x a)) (Or (Not (And (Eq x b) (Eq y b))) (Not (And (Eq x b) (Eq y b)))))) := sorry
...
have lean_s51 : (Or (Not (Eq x a)) (Or (Not (Eq y a)) (Eq (f x) (f y)))) :=
  (scope (fun lean_a6 : (Eq x a) =>
    (scope (fun lean_a7 : (Eq y a) =>
      have lean_s51 : (And (Eq y a) (Eq x a)) := sorry
