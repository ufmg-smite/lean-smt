...
have lean_s10 : (Or (Not (Or x0 z0)) (Or x0 z0)) := by timed equivElim1 lean_s9
have lean_s11 : (Or (Or x0 z0) (Not (Or x0 z0))) := by permutateOr lean_s10, [1, 0], (- 1)
/- have lean_s11 : (Or (Or x0 z0) (Not (Or x0 z0))) := sorry -/
  ...
  (scope (fun lean_a14 : (f (Or x0 z0)) =>
    (scope (fun lean_a15 : (Or x0 z0) =>
      (scope (fun lean_a16 : True =>
        ...
        have lean_s14 : (Eq (Or x0 z0) True) := trueIntro lean_a15
