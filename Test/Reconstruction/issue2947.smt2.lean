...
theorem th0 : (Eq (Eq (Not (Not (f True))) (f True)) (Eq (f True) (Not (Not (f True))))) → (Eq (Eq (f True) (f True)) True) → (Eq (Eq (Or (f True) (f False)) (Or (f True) (f False))) (Eq (Or (f True) (f False)) (Or (f True) (f False)))) → (Eq (Eq True False) False) → (Eq (Not False) True) → (Eq (Eq True True) True) → (Eq (Eq (Or (f True) (f False)) (Or (f True) (f False))) True) → (Eq (Not (Not False)) False) → (Eq (Not (Not (f True))) (f True)) → (Eq (Eq (Not (Not (Or (f True) (f False)))) (Or (f True) (f False))) (Eq (Or (f True) (f False)) (Not (Not (Or (f True) (f False)))))) → (Eq (ite (f True) True (f False)) (Or (f True) (f False))) → (Eq (Eq False False) (Not False)) → (Eq (Not (Not (Or (f True) (f False)))) (Or (f True) (f False))) → (Eq (Eq False False) True) → (Eq (Eq (Not (Not False)) False) (Eq False (Not (Not False)))) → (Not (f True)) → (f (ite (f True) True (f False))) → False :=
fun lean_r0 : (Eq (Eq (Not (Not (f True))) (f True)) (Eq (f True) (Not (Not (f True))))) =>
fun lean_r1 : (Eq (Eq (f True) (f True)) True) =>
fun lean_r2 : (Eq (Eq (Or (f True) (f False)) (Or (f True) (f False))) (Eq (Or (f True) (f False)) (Or (f True) (f False)))) =>
fun lean_r3 : (Eq (Eq True False) False) =>
fun lean_r4 : (Eq (Not False) True) =>
fun lean_r5 : (Eq (Eq True True) True) =>
fun lean_r6 : (Eq (Eq (Or (f True) (f False)) (Or (f True) (f False))) True) =>
fun lean_r7 : (Eq (Not (Not False)) False) =>
fun lean_r8 : (Eq (Not (Not (f True))) (f True)) =>
fun lean_r9 : (Eq (Eq (Not (Not (Or (f True) (f False)))) (Or (f True) (f False))) (Eq (Or (f True) (f False)) (Not (Not (Or (f True) (f False)))))) =>
fun lean_r10 : (Eq (ite (f True) True (f False)) (Or (f True) (f False))) =>
fun lean_r11 : (Eq (Eq False False) (Not False)) =>
fun lean_r12 : (Eq (Not (Not (Or (f True) (f False)))) (Or (f True) (f False))) =>
fun lean_r13 : (Eq (Eq False False) True) =>
fun lean_r14 : (Eq (Eq (Not (Not False)) False) (Eq False (Not (Not False)))) =>
    ...
    (scope (fun lean_a18 : True =>
      (scope (fun lean_a19 : (Or (f True) (f False)) =>
        (scope (fun lean_a20 : (f (Or (f True) (f False))) =>
          have lean_s0 : (Eq (f (ite (f True) True (f False))) (f (Or (f True) (f False)))) := flipCongrArg lean_r10 [f]
          ...
          have lean_s7 : (Eq (Eq (Or (f True) (f False)) (Or (f True) (f False))) True) := Eq.trans lean_s6 lean_r6
          ...
          have lean_s11 : (f (Or (f True) (f False))) := eqResolve lean_a16 lean_s10
...
have lean_s6 : (Eq (Eq (f True) (Not (Not (f True)))) (Eq (f True) (f True))) := congr lean_s5 lean_r8
have lean_s7 : (Eq (Eq (f True) (Not (Not (f True)))) True) := Eq.trans lean_s6 lean_r1
have lean_s8 : (Eq (Eq (Not (Not (f True))) (f True)) True) := Eq.trans lean_r0 lean_s7
  ...
  (scope (fun lean_a20 : (f (Or (f True) (f False))) =>
    (scope (fun lean_a21 : (Not (Or (f True) (f False))) =>
      (scope (fun lean_a22 : (Not False) =>
        ...
        have lean_s27 : (Eq (f (ite (f True) True (f False))) (f (Or (f True) (f False)))) := flipCongrArg lean_r10 [f]
        ...
        have lean_s34 : (Eq (Eq (Or (f True) (f False)) (Or (f True) (f False))) True) := Eq.trans lean_s33 lean_r6
        ...
        have lean_s38 : (f (Or (f True) (f False))) := eqResolve lean_a16 lean_s37
...
have lean_s30 : (Eq (Eq (Or (f True) (f False)) (Not (Not (Or (f True) (f False))))) (Eq (Or (f True) (f False)) (Or (f True) (f False)))) := congr lean_s29 lean_r12
have lean_s31 : (Eq (Eq (Or (f True) (f False)) (Not (Not (Or (f True) (f False))))) True) := Eq.trans lean_s30 lean_r6
have lean_s32 : (Eq (Eq (Not (Not (Or (f True) (f False)))) (Or (f True) (f False))) True) := Eq.trans lean_r9 lean_s31
...
have lean_s37 : (Eq (Eq False (Not (Not False))) (Eq False False)) := congr lean_s36 lean_r7
have lean_s38 : (Eq (Eq False (Not (Not False))) True) := Eq.trans lean_s37 lean_r13
have lean_s39 : (Eq (Eq (Not (Not False)) False) True) := Eq.trans lean_r14 lean_s38
...
have lean_s49 : (Not False) := eqResolve lean_s48 lean_r11
let lean_s50 := by R1 lean_s47, lean_s49, False, [(- 1), 0]
have lean_s51 : (Eq (f (ite (f True) True (f False))) (f (Or (f True) (f False)))) := flipCongrArg lean_r10 [f]
...
have lean_s58 : (Eq (Eq (Or (f True) (f False)) (Or (f True) (f False))) True) := Eq.trans lean_s57 lean_r6
...
have lean_s62 : (f (Or (f True) (f False))) := eqResolve lean_a16 lean_s61
...
let lean_s73 := Eq.trans lean_r11 lean_s72
have lean_s74 : (Eq (Eq False False) True) := Eq.trans lean_s73 lean_r4
...
have lean_s81 : (Eq (Eq (Or (f True) (f False)) (Or (f True) (f False))) (Eq (Or (f True) (f False)) (Or (f True) (f False)))) := Eq.trans lean_s80 lean_r2
have lean_s82 : (Eq (Eq (Or (f True) (f False)) (Or (f True) (f False))) (Eq (Or (f True) (f False)) (Or (f True) (f False)))) := Eq.trans lean_r2 lean_s81
...
have lean_s94 : (Not (f True)) := eqResolve lean_a15 lean_s93
